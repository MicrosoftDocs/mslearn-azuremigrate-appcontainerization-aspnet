...
Invoke-WebRequest 'https://github.com/MicrosoftDocs/mslearn-azuremigrate-appcontainerization-aspnet/blob/main/ASP.NET%20Containerization/parts.zip' -OutFile 'D:\parts.zip'
